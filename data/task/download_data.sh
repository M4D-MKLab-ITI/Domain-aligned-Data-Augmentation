# https://github.com/amazon-research/transformers-data-augmentation/blob/main/src/utils/download_and_prepare_datasets.sh
#!/usr/bin/env bash
...
# RT dataset 
mkdir -p datasets/rt
wget -O datasets/rt/review_polarity.tar.gz https://www.cs.cornell.edu/people/pabo/movie-review-data/review_polarity.tar.gz
tar zxvf datasets/rt/review_polarity.tar.gz -C datasets/rt/
