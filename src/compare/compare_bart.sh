          ...
          do
            ...
            for MASKLEN in word span;
                ...
                fairseq-generate $DATABIN \
                        ...
                        --required-batch-size-multiple 1 --beam 10 --nbest $n_samples --lenpen 5 \
         ...
         for mr in 40;
              do
                ...
                for MASKLEN in span word;
                    ...
                    python $SRC/task/classifier.py --task $TASK --data_dir $MODELDIR --seed ${i} --cache $CACHE > $RAWDATADIR/bert_bart_l5_${MASKLEN}_mask_${MRATIO}_prefix_${PREFIXSIZE}.log
                done
           done
    done
done
