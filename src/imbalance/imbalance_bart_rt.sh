            ...
            for mr in 40;
                do
                    ...
                    for MASKLEN in "${masks[@]}";
                        ...
                        python $SRC/task/classifier.py --task $TASK --data_dir $MODELDIR --seed ${seed_no} --max_seq_length 512 --cache $CACHE > $RAWDATADIR/bert_bart_l5_${MASKLEN}_mask_${MRATIO}_prefix_${PREFIXSIZE}_base.log 
                    done
            done
        done
    done
